...
public class adminServicio extends javax.swing.JFrame {
    ...
    /**
     * Creates new form adminServicio
     */
    ...
    public adminServicio(String usuario) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Administrador de servicios");
        ...
        jButton2.setText("Editar/Eliminar servicio");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            agregarServicio as;
            as = new agregarServicio(this.usuario);
            as.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            editarServicio es;
            es = new editarServicio(this.usuario);
            es.setVisible(true);
        } catch (SQLException ex) {
            Logger.getLogger(adminServicio.class.getName()).log(Level.SEVERE, null, ex);
        }
