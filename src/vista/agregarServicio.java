...
public class agregarServicio extends javax.swing.JFrame {
    ...
    public agregarServicio(String usuario) throws SQLException {
        initComponents();
        this.usuario = usuario;
        this.c = new contServicio();
        List<Rubro> rubros = c.obtenerRubros();
    ...
    private void initComponents() {
        ...
        comboObligatorio = new javax.swing.JCheckBox();
        ...
        comboObligatorio.setText("Obligatorio");
        ...
        comboRubro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ninguno" }));
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtCosto, javax.swing.GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        adminServicio as = new adminServicio(this.usuario);
        as.setVisible(true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        boolean obligatorio = comboObligatorio.isSelected();
        int obligatorio_int = 0;
        if (obligatorio){
            obligatorio_int = 1;
        }else{
            obligatorio_int = 0;
        ...
        if (!identificador.equals("") && !actividades.equals("") && !costo.equals("")){
            Servicio s = new Servicio(identificador, actividades, obligatorio_int, Integer.parseInt(costo));
            try {
                c.insertarServicio(s);
            } catch (SQLException ex) {
                Logger.getLogger(agregarServicio.class.getName()).log(Level.SEVERE, null, ex);
            }
            if (!rubro.equals("Ninguno")){
                try {
                    c.insertarRuborServicio(identificador, rubro);
                } catch (SQLException ex) {
                    Logger.getLogger(agregarServicio.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    private javax.swing.JCheckBox comboObligatorio;
